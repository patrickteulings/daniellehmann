...
if (!class_exists('daniellehmann_Customize')) {
  /**
   * Customizer Settings.
   *
   * @since Twenty Twenty-One 1.0
   */
  class daniellehmann_Customize
  {
    ...
    public function register($wp_customize)
    {
      ...
      $wp_customize->add_control(
        ...
        array(
          ...
          'label'   => esc_html__('Display Site Title & Tagline', 'daniellehmann'),
        )
      );
      ...
      $wp_customize->add_section(
        'excerpt_settings',
        array(
          'title'    => esc_html__('Excerpt Settings', 'daniellehmann'),
          'priority' => 120,
        )
      );
      ...
      $wp_customize->add_control(
        ...
        array(
          ...
          'label'   => esc_html__('On Archive Pages, posts show:', 'daniellehmann'),
          'choices' => array(
            'excerpt' => esc_html__('Summary', 'daniellehmann'),
            'full'    => esc_html__('Full text', 'daniellehmann'),
          ),
        )
      );
      ...
      $wp_customize->register_control_type('daniellehmann_Customize_Color_Control');
      ...
      $wp_customize->add_control(
        new daniellehmann_Customize_Color_Control(
          $wp_customize,
          'background_color',
          array(
            'label'   => esc_html_x('Background color', 'Customizer control', 'daniellehmann'),
            'section' => 'colors',
            'palette' => $colors,
          )
        )
